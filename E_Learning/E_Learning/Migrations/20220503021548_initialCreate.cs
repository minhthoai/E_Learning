        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoiDungKiemTra = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaBangDiem = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenHocSinh = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NgaySinh = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ChuyenCan = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DiemMieng = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HeSo1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HeSo2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DiemTrungBinh = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DiemTrungBinhCaNam = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaBGH = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenBGH = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BanGiamHieu", x => x.MaBGH);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Class", x => x.MaLop);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Detail_Class", x => x.MaLop);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaHoiDap = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Ma_KhoaHoc = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaStudent = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenStudent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NgaySinh = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManageStudent", x => x.MaStudent);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManageTeacher", x => x.MaTeacher);
                });
