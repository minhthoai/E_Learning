...
using E_Learning_v1.Model.Admin;
...
namespace E_Learning_v1.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        //public async Task<IActionResult> ResetPasswordToken(Model. ResetPasswordModel model)
        //{
        //    var user = await _userManager.FindByNameAsync(model.Username);
        //    if (user == null)
        //        return StatusCode(StatusCodes.Status404NotFound, new ResponseAdmin { Status = "Error", Message = "User does not exists" });
        ...
        //public async Task<IActionResult> ResetPassword([FromBody]Model. ResetPasswordModel model)
        //{
        //    var user = await _userManager.FindByNameAsync(model.Username);
        //    if (user == null)
        //        return StatusCode(StatusCodes.Status404NotFound, new ResponseAdmin { Status = "Error", Message = "User does not exists" });
        ...
        //        return StatusCode(StatusCodes.Status400BadRequest, new ResponseAdmin { Status = "Error", Message = "Invalid token" });
